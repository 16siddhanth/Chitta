...
export const saveEmotionalEntry = async (entry: Omit<EmotionalEntry, "id" | "timestamp">): Promise<void> => {
...
export const saveChatMessage = async (message: Omit<ChatMessage, "id" | "timestamp">): Promise<void> => {
  const userData = await getUserData()
